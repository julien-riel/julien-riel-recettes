...
export function getBaseIngredient(ingredient) {
  ...
  const ingredientGroups = [
    ...
    // Viandes - coupes spécifiques (plus spécifique d'abord)
    ['poitrine de poulet', ['poitrine de poulet', 'poitrines de poulet']],
    ['hauts de cuisses de poulet', ['hauts de cuisse de poulet', 'cuisses de poulet', 'hauts de cuisses de poulet', 'cuisse de poulet']],
    ['poulet', ['poulet']],
    ['bœuf haché', ['bœuf haché', 'boeuf haché']],
    ['bavette de bœuf', ['bavette', 'bavette de bœuf']],
    ['rumsteck', ['rumsteck']],
    ['bœuf à mijoter', ['bœuf à mijoter', 'boeuf à mijoter', 'cubes de bœuf']],
    ['bœuf', ['bœuf', 'boeuf']],
    ['porc haché', ['porc haché']],
    ['poitrine de porc', ['poitrine de porc']],
    ['épaule de porc', ['épaule de porc']],
    ['porc à mijoter', ['porc à mijoter', 'cubes de porc']],
    ['porc', ['porc']],
    ['agneau haché', ['agneau haché']],
    ['épaule d\'agneau', ['épaule d\'agneau']],
    ['agneau', ['agneau']],
    ['crevettes', ['crevettes', 'crevette']],
    ['filet de poisson blanc', ['filet de poisson blanc']],
    ['cabillaud', ['cabillaud']],
    ['saumon', ['saumon', 'filet de saumon', 'pavé de saumon']],
    ['poisson blanc', ['poisson blanc', 'lotte']],
